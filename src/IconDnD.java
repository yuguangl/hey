...
//yo i copied this shit from googerl
public class IconDnD extends JFrame {
    ...
    private void initUI() {
        ...
        var icon1 = new ImageIcon("src/resources/emre.jpg");
        var icon2 = new ImageIcon("src/resources/emre.jpg");
        var icon3 = new ImageIcon("src/resources/emre.jpg");
